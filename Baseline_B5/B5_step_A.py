...
from data.data_loader import get_B5_A_loaders
from helper import check, setup_logger,load_yaml_config
from eval_model import Person_Classifer
...
if __name__ == '__main__':
    check()
    # Load B5 step A Configuration
    print("Loading B5 step A Training Configuration...")
    ...
    logger= setup_logger()
    logger.info("Starting Baseline_B5_step_A Training")
    ...
    for epoch in range(num_epochs):
        ...
        if val_loss < best_val_loss:
            ...
            logger.info(f"Best model saved to: best_Baseline_B5_A_model.pth")
    ...
    model.load_state_dict(torch.load('best_Baseline_B5_A_model.pth'))
