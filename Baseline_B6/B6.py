...
from eval_model import collate_fn,Person_Classifer,Group_Classifer
...
if __name__ == '__main__':
    ...
    print("Loading Baseline 6 Training Configuration...")
    ...
    logger= setup_logger()
    logger.info("Starting Baseline_B6 Training")
    ...
    Person=Person_Classifer(9)
    Person.load_state_dict(torch.load('Baseline_B3/B3_A/resulates/best_volleyball_b3_model.pth'))
    ...
    for epoch in range(num_epochs):
        ...
        if val_loss < best_val_loss:
            ...
            logger.info(f"Best model saved to: best_Baseline_B6_model.pth")
    ...
    model.load_state_dict(torch.load('best_Baseline_B6_model.pth'))
