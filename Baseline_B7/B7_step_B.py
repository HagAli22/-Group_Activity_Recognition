...
if __name__ == '__main__':
    ...
    Person.load_state_dict(torch.load('Baseline_B7/results/best_Baseline_B7_A_model.pth'))
    ...
    for epoch in range(num_epochs):
        ...
        if val_loss < best_val_loss:
            ...
            logger.info(f"Best model saved to: best_Baseline_B7_B_model.pth")
    ...
    model.load_state_dict(torch.load('best_Baseline_B7_B_model.pth'))
