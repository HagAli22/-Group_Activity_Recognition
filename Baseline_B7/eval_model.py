...
class Group_Classifer(nn.Module):
    def __init__(self, Person_Classifer , num_classes=8):
        ...
        self.lstm2=nn.LSTM(2048,self.hidden_size,num_layers=self.num_layers,batch_first=True)
...
if __name__ == '__main__':
    ...
    print("Loading Baseline 7 Configuration...")
    ...
    Average Loss: 0.5400
    Overall F1 Score (Macro): 0.8176
    Overall F1 Score (Weighted): 0.8454
